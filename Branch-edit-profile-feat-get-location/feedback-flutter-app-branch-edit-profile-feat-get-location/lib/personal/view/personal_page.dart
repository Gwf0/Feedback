      ...
      child: BlocBuilder<PersonalBloc, PersonalState>(
        builder: (context, state) {
          ...
          if (state is PersonalLoaded) {
            String setSex() {
              if (state.userPersonal.sex == 'male') {
                return ('Мужской');
              }
              if (state.userPersonal.sex == 'female') {
                return ('Женский');
              } else {
                return ('');
              }
            ...
            String setEducation() {
              if (state.userPersonal.education == 'higher') {
                return ('Высшее образование');
              }
              if (state.userPersonal.education == 'secondary') {
                return ('Комплексная проверка');
              }
              if (state.userPersonal.education == 'post_secondary') {
            ...
            String setRole() {
              if (state.userPersonal.role == 'secretbuyer') {
