...
class PaymentBloc extends Bloc<PaymentEvent, PaymentState> {
  ...
  PaymentBloc({required this.paymentRepository}) : super(PaymentInitial()) {
    ...
    on<EditPaymentFetchEvent>(_fetchPaymentEdit);
  }
  ...
  FutureOr<void> _fetchPaymentEdit(
      EditPaymentFetchEvent event, Emitter<PaymentState> emit) async {
    try {
      emit(PaymentLoading());
      final payment = await paymentRepository.postUserPayment(
